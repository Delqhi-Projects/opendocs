...
export function App() {
  ...
  useKeyboardShortcuts([
    ...
    { key: 'k', ctrl: true, action: () => setCommandOpen(true), description: 'Command Palette' },
    { key: 'b', ctrl: true, action: () => setSidebarOpen(s => !s), description: 'Toggle Sidebar' },
    { key: 'Escape', action: () => {
      setAiOpen(false)
      setChatOpen(false)
      setAuditOpen(false)
          ...
          <div className="flex h-12 shrink-0 items-center justify-between border-b border-zinc-200 bg-white px-4 dark:border-zinc-800 dark:bg-zinc-950">
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800 lg:hidden"
              >
